...
public class Test {
	...
	reports.setSystemInfo("Machine", "saiful");
	...
	// logout
	//browsers.findElement(By.xpath("/html/body/div/table/tbody/tr/td[2]/table/tbody/tr[4]/td/table/tbody/tr[1]/td[2]/table/tbody/tr[7]/td/table/tbody/tr/td[3]/a/img")).click();
	// browsers.get("http://newtours.demoaut.com/mercurypurchase2.php"); 	
	// browsers.findElement(By.linkText("SIGN-OFF")).click();
	//.findElement(By.xpath("/html/body/div/table/tbody/tr/td[2]/table/tbody/tr[4]/td/table/tbody/tr[1]/td[2]/table/tbody/tr[7]/td/table/tbody/tr/td[3]/a/img")).click();
	 		
   }
   @org.testng.annotations.Test
   public void passFailed() {
   test = reports.createTest("second");
	System.out.println("This is our pass test"); 
